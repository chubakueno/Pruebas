				...
				<table class="table">
					...
					<tbody>
						...
						<tr>
							...
							<td><a
								href="<%=getServletContext().getContextPath()%>/CategoriaEditar?categoria=<%=categorias.get(i).getIdCategory()%>">Editar</a>
								<a
								href="<%=getServletContext().getContextPath()%>/CategoriaEliminar?categoria=<%=categorias.get(i).getIdCategory()%>">Eliminar</a>
							</td>
						</tr>
						<%
							}
