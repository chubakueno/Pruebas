				...
				<table class="table">
					...
					<tbody>
						...
						<tr>
							...
							<td><a
								href="<%=getServletContext().getContextPath()%>/ProveedorEditar?proveedor=<%=proveedores.get(i).getIdProvider()%>">Editar</a>
								<a
								href="<%=getServletContext().getContextPath()%>/ProveedorEliminar?proveedor=<%=proveedores.get(i).getIdProvider()%>">Eliminar</a>
							</td>
						</tr>
						<%
							}
