				...
				<table class="table">
					...
					<tbody>
						...
						<tr>
							...
							<td><a
								href="<%=getServletContext().getContextPath()%>/ProductoEditar?producto=<%=productos.get(i).getIdProduct()%>">Modificar</a>
								<a
								href="<%=getServletContext().getContextPath()%>/ProductoEliminar?producto=<%=productos.get(i).getIdProduct()%>">Eliminar</a>
							</td>
						</tr>
						<%
							}
