		...
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			...
			<form method="post" name="formulario"
				...
				<div class="form-group">
					...
					%>
					<label>Proveedor:</label> <select required
						oninvalid="this.setCustomValidity('Falta llenar el campo Proveedor');"
						oninput="setCustomValidity('')" name="listaProveedores"
						id="listaProveedores">
						<option disabled selected hidden="true">Seleccionar</option>
						<%
				...
				<div class="form-group">
					...
					%>
					<label>Categoria:</label> <select required
						oninvalid="this.setCustomValidity('Falta llenar el campo Categoria');"
						oninput="setCustomValidity('')" name="listaCategorias"
						id="listaCategorias">
						<option disabled selected hidden="true">Seleccionar</option>
						<%
				...
				<button type="submit"
					onclick="return confirm('¿Esta seguro de registrar este producto?')"
