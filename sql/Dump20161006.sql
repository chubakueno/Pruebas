...
CREATE TABLE `product` (
  ...
  CONSTRAINT `fk_Product_Category` FOREIGN KEY (`Category_idCategory`) REFERENCES `category` (`idCategory`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `product` VALUES (1,'Hot dog',15,2,2),(18,'Silla',100,12,13);
...
INSERT INTO `provider` VALUES (1,'prov'),(2,'UPC hard'),(3,'UPC cars'),(11,'prov1'),(13,'Ferrini'),(14,'NuevoProv');
...
INSERT INTO `user` VALUES (1,'admin','admin','admin'),(2,'xbk@gmail.com','123','admin');
